...
- (void)drawXAxisLine {
    ...
    xAxisLayer.strokeColor = [UIColor colorWithRed:222/255.0f green:222/255.0f blue:222/255.0f alpha:1.0f].CGColor;
...
- (void)drawChartLine {
    ...
    pAxisLayer.lineWidth = 1.f;
    pAxisLayer.strokeColor = [DEF_NAVIGATIONBAR_COLOR CGColor];
...
- (void)drawGradient {
    ...
    gradientLayer.colors = @[(__bridge id)[UIColor colorWithRed:241.0/255.0 green:104.0/255.0 blue:108.0/255.0 alpha:0.4].CGColor,(__bridge id)[UIColor colorWithWhite:1 alpha:0.1].CGColor];
...
- (void)setupCircleViews {
    for (int i = 0; i < self.pointArrM.count; i++) {
        ...
        circleView.borderColor = DEF_NAVIGATIONBAR_COLOR;
